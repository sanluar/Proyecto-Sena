...
-- -----------------------------------------------------
-- Table `mydb`.`OrdenDeCompra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`OrdenDeCompra` (
  `idPedido` INT(11) NOT NULL COMMENT 'Este atributo, representa el identificador del pedido. Este es un dato unico e irrepetible dentro de la tabla y es de caracter obligatorio.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`OrdenCompra` (
  `idOrdenCompra` INT NOT NULL COMMENT '',
  `fechaOrdenCompra` DATE NULL COMMENT '',
  `proveedor_Persona_pkIdPersona` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`idOrdenCompra`, `proveedor_Persona_pkIdPersona`)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `mydb`.`ProductosSolicitados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ProductosSolicitados` (
  `OrdenCompra_idOrdenCompra` INT NOT NULL COMMENT '',
  `productoPedido` VARCHAR(30) NOT NULL COMMENT '',
  `valorUnidad` INT(8) NOT NULL COMMENT '',
  `ivaUnidad` DECIMAL(7) NOT NULL COMMENT '',
  `cantidadProducto` INT(7) NOT NULL COMMENT '',
  `subTotal` INT(10) NOT NULL COMMENT '',
  `ivaTotal` DECIMAL(7) NOT NULL COMMENT '',
  `valorTotal` VARCHAR(10) NOT NULL COMMENT '',
